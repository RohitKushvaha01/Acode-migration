...
public class Executor extends Service {
    ...
    private class IncomingHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            if (action.equals("exec_result")) {
                runner.Callback callbackContext = getCallbackContext(id);
                ...
                String pid = id;
                runner.Callback callbackContext = getCallbackContext(pid);
    ...
    private void exec(String execId, String cmd, String alpine) {
        ...
        try {
            ...
            runner.Callback callbackContext = getCallbackContext(execId);
            if (callbackContext != null) {
    ...
    private void listProcesses(String requestId) {
        ...
        try {
            ...
            runner.Callback callbackContext = getCallbackContext(requestId);
            if (callbackContext != null) {
